...
namespace SampleKernel
{
    ...
    public static class Kernel
    {
        ...
        private static unsafe void PrintHelloWorld()
        {
	        ushort* DisplayMemoryPtr = (ushort*)0xB8000;
	        int i = 0;
	        DisplayMemoryPtr[i++] = (0x0200 | 'H');
	        DisplayMemoryPtr[i++] = (0x0200 | 'e');
	        DisplayMemoryPtr[i++] = (0x0200 | 'l');
	        DisplayMemoryPtr[i++] = (0x0200 | 'l');
	        DisplayMemoryPtr[i++] = (0x0200 | 'o');
	        DisplayMemoryPtr[i++] = (0x0200 | ',');
	        DisplayMemoryPtr[i++] = (0x0200 | ' ');
	        DisplayMemoryPtr[i++] = (0x0200 | 'w');
	        DisplayMemoryPtr[i++] = (0x0200 | 'o');
	        DisplayMemoryPtr[i++] = (0x0200 | 'r');
	        DisplayMemoryPtr[i++] = (0x0200 | 'l');
	        DisplayMemoryPtr[i++] = (0x0200 | 'd');
	        DisplayMemoryPtr[i++] = (0x0200 | '!');
        }
    }
