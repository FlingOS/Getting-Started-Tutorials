...
namespace SampleKernel
{
    public static class Kernel
    {
        ...
        [Drivers.Compiler.Attributes.PluggedMethod(ASMFilePath = @"ASM\DevicesConfigure")]
        private static void DevicesConfigure()
        {
        }
        ...
        static uint CurrentLocation = 0;
        [Drivers.Compiler.Attributes.NoGC]
        public static unsafe void ShiftDisplayUpOneLine()
        {
	        char* DisplayMemoryPtr = (char*)0xB8000;
	        for(uint i = 0; i < 2000 - 80; i++) 
	        {
		        DisplayMemoryPtr[i] = DisplayMemoryPtr[i + 80];
	        }
	        for(uint i = 2000 - 1; i > 2000 - 80; i--)
	        {
		        DisplayMemoryPtr[i] = (char)0x0000;
	        }
        }
        [Drivers.Compiler.Attributes.NoGC]
        public static unsafe void Print(SampleKernel.String text)
        {
	        ...
	        for(int i = 0; i < text.length; i++)
	        {
                ...
                SetCursorPos((ushort)CurrentLocation);
        ...
        [Drivers.Compiler.Attributes.PluggedMethod(ASMFilePath = @"ASM\SetCursorPos")]
        private static void SetCursorPos(ushort pos)
        {
        }
