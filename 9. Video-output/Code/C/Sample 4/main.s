...
.LFB6:
	...
	jmp	.L277
.L281:
	mov	eax, DWORD PTR CurrentLocation.1935
	cmp	eax, 2000
	jne	.L278
	call	ShiftDisplayUpOneLine
	mov	eax, DWORD PTR CurrentLocation.1935
	sub	eax, 80
	mov	DWORD PTR CurrentLocation.1935, eax
.L278:
	mov	edx, DWORD PTR [ebp-8]
	mov	eax, DWORD PTR [ebp+8]
	add	eax, edx
	...
	cmp	al, 10
	jne	.L279
	mov	ebx, DWORD PTR CurrentLocation.1935
	mov	ecx, DWORD PTR CurrentLocation.1935
	mov	edx, -858993459
	mov	eax, ecx
	mul	edx
	shr	edx, 6
...
.L279:
	mov	eax, DWORD PTR CurrentLocation.1935
	lea	edx, [eax+1]
	mov	DWORD PTR CurrentLocation.1935, edx
	lea	edx, [eax+eax]
	mov	eax, DWORD PTR [ebp-12]
	add	edx, eax
...
.LFE8:
	.size	main, .-main
	.local	CurrentLocation.1935
	.comm	CurrentLocation.1935,4,4
	.ident	"GCC: (GNU) 4.8.2"
