...
.LFB7:
	...
	jmp	.L278
.L282:
	mov	eax, DWORD PTR CurrentLocation.1939
	cmp	eax, 2000
	jne	.L279
	call	ShiftDisplayUpOneLine
	mov	eax, DWORD PTR CurrentLocation.1939
	sub	eax, 80
	mov	DWORD PTR CurrentLocation.1939, eax
.L279:
	mov	edx, DWORD PTR [ebp-8]
	mov	eax, DWORD PTR [ebp+8]
	add	eax, edx
	...
	cmp	al, 10
	jne	.L280
	mov	ebx, DWORD PTR CurrentLocation.1939
	mov	ecx, DWORD PTR CurrentLocation.1939
	mov	edx, -858993459
	mov	eax, ecx
	mul	edx
	shr	edx, 6
...
.L280:
	mov	eax, DWORD PTR CurrentLocation.1939
	lea	edx, [eax+1]
	mov	DWORD PTR CurrentLocation.1939, edx
	lea	edx, [eax+eax]
	mov	eax, DWORD PTR [ebp-12]
	add	edx, eax
...
.LFE9:
	.size	main, .-main
	.local	CurrentLocation.1939
	.comm	CurrentLocation.1939,4,4
	.ident	"GCC: (GNU) 4.8.2"
