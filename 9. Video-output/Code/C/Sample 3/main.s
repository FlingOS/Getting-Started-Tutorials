...
.L275:
	...
	cmp	al, 10
	jne	.L273
	mov	ebx, DWORD PTR CurrentLocation.1925
	mov	ecx, DWORD PTR CurrentLocation.1925
	mov	edx, -858993459
	mov	eax, ecx
	mul	edx
	shr	edx, 6
	...
	sub	eax, edx
	add	eax, 80
	mov	DWORD PTR CurrentLocation.1925, eax
	jmp	.L274
.L273:
	mov	eax, DWORD PTR CurrentLocation.1925
	lea	edx, [eax+1]
	mov	DWORD PTR CurrentLocation.1925, edx
	lea	edx, [eax+eax]
	mov	eax, DWORD PTR [ebp-12]
	add	edx, eax
...
.LFE7:
	.size	main, .-main
	.local	CurrentLocation.1925
	.comm	CurrentLocation.1925,4,4
	.ident	"GCC: (GNU) 4.8.2"
